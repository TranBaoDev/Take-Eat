...
class CartEvent with _$CartEvent {
  ...
  const factory CartEvent.updateQuantityLocally(String itemId, int quantity) = _UpdateQuantityLocally;
  const factory CartEvent.saveCartChanges(String userId) = _SaveCartChanges;
  const factory CartEvent.changeFilterStatus(OrderStatus status) = _ChangeFilterStatus;
  const factory CartEvent.updateStatus(String itemId, OrderStatus status) = _UpdateStatus;
}
